-- Verknüpfung nur für genau ein Profil pro E-Mail (vermeidet Unique-Fehler auf auth_user_id).
-- Insert-Pfad: Rolle immer 'lead', damit keine ungültige Enum-Cast-Exception.
