    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl p-6 space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg bg-card border border-blue-500/30 p-5">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-600">
                <Users className="h-6 w-6 text-white" />
              </div>
              <div>
                <p className="text-sm text-blue-300">Gesamt Nutzer</p>
          ...
          <div className="rounded-lg bg-card border border-blue-500/30 p-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-blue-300">Aktive Organisationen</p>
                <p className="text-2xl font-bold text-blue-100">
                  {activeOrgs || 0}
                </p>
              </div>
          ...
          <div className="rounded-lg bg-card border border-blue-500/30 p-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-blue-300">Systemstatus</p>
        ...
        {/* Organisationsliste */}
        <div className="overflow-hidden rounded-lg bg-card border border-blue-500/30">
          <div className="border-b border-blue-500/30 px-6 py-4">
          ...
          <div className="divide-y divide-blue-500/30">
            {organizations.map((org) => (
              <div
                key={org.id}
                className="px-6 py-4 hover:bg-blue-500/5 transition-colors"
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Link
                      href={`/${org.slug}/admin`}
                      className="inline-flex items-center rounded-md bg-blue-500/80 px-3 py-1.5 text-xs font-semibold text-white hover:bg-blue-500"
                    >
                      Admin-Board
                    </Link>
            ...
            {organizations.length === 0 && (
              <p className="px-6 py-6 text-sm text-blue-300">
